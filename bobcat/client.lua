...
RegisterNetEvent('bobcat:startHeist')
AddEventHandler('bobcat:startHeist',function() 
    local ped = PlayerPedId()
    local coords = GetEntityCoords(ped)
    QBCore.Functions.TriggerCallback("bobcat:enoughCops",function(enoughCops)  
        if enoughCops >= 1 then     
            if #(coords - Config.FirstDoor) < 2.0 then
                exports["memorygame"]:thermiteminigame(3, 3, 3, 10, function() 
                    firstDoor()
                    TriggerServerEvent("bobcat:removeItem", "thermitecharge")
                end, function() 
                    print('failed')
                end) 
...
function firstDoor()
    ...
    TriggerServerEvent("bobcat:particles", method)
    ...
    TriggerEvent("bobcat:openFirstDoor") 
...
function secondDoor() 
    ...
    DetachEntity(bomb, 1, 1)
    FreezeEntityPosition(bomb, true)
    TriggerServerEvent("bobcat:particles2", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomb)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("bobcat:openSecondDoor")
...
-- Doorlocks
RegisterNetEvent('bobcat:openFirstDoor')
AddEventHandler('bobcat:openFirstDoor', function()  
    TriggerServerEvent('dw-doorlock:server:updateState', 1, false)  
end)

RegisterNetEvent('bobcat:openSecondDoor')
AddEventHandler('bobcat:openSecondDoor', function()  
    TriggerServerEvent('dw-doorlock:server:updateState', 2, false) 
    Citizen.Wait(500)
    TriggerEvent('bobcat:createPed')
    TriggerEvent('dispatch:bobcatRobbery')
end)

RegisterNetEvent('bobcat:openThirdDoor')
AddEventHandler('bobcat:openThirdDoor', function()  
    TriggerServerEvent('dw-doorlock:server:updateState', 3, false)   
    Citizen.Wait(500)
    TriggerServerEvent("bobcat:removeItem", "bobcatsecuritycard")
    TriggerEvent('bobcat:createPed') 
end)

-- Particles 
RegisterNetEvent("bobcat:ptfxparticle")
AddEventHandler("bobcat:ptfxparticle", function(method)
    local ptfx
...
RegisterNetEvent("bobcat:ptfxparticle2")
AddEventHandler("bobcat:ptfxparticle2", function(method)
    local ptfx
...
-- Ped Create
RegisterNetEvent('bobcat:createPed')
AddEventHandler('bobcat:createPed', function()
    ...
    TriggerServerEvent('bobcat:syncPedsSV', peds, ids)
end)

-- Syncing Peds
RegisterNetEvent('bobcat:syncPeds')
AddEventHandler('bobcat:syncPeds', function(peds)
...
RegisterNetEvent('bobcat:commandPed') 
AddEventHandler('bobcat:commandPed', function() 
	...
	Citizen.Wait(6500)
	TriggerEvent("bobcat:commandPed2")
end)

RegisterNetEvent('bobcat:commandPed2') 
AddEventHandler('bobcat:commandPed2', function()
    ...
    TriggerEvent("bobcat:explodeVaultDoor")
    TriggerEvent("bobcat:propCreate")
end)

RegisterNetEvent('bobcat:explodeVaultDoor') 
AddEventHandler('bobcat:explodeVaultDoor', function()
...
-- Vault Props 
RegisterNetEvent('bobcat:propCreate')
AddEventHandler('bobcat:propCreate', function()
...
RegisterNetEvent('bobcat:giveWeapon') 
AddEventHandler('bobcat:giveWeapon', function()  
...
function grabWeapons()
    QBCore.Functions.Progressbar('plundering', 'Collecting Weapons', 10000, false, true, {
        ...
        TriggerServerEvent('bobcat:giveRandomWeapon')  
    end, function() -- Cancel
        ClearPedTasks(PlayerPedId()) 
